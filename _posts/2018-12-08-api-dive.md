...
GraphQL has a bit of a learning curve to understand constructs particular to it(query, schema, type, mutation...).
Requests also use a custom json-like format that may require tweaking your current testing tools or changing to graphql specific ones.
