...
An API specification can be used to generate an API documentation.The most common API specification formats are Swagger/ OpenAPI spec, RAML and API Blueprint.
...
Swagger also provides tooling for the API lifecyle.
...
Most of the tooling provided around apiblueprint is developed by the community.
