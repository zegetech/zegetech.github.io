...
intro: | 
  So, you probably already know [what docker is](../../10/29/what-and-why-docker.html) and what it can do for you. You (hopefully) also know that you don't need to be deploying thousands of services in order to start using docker now.
